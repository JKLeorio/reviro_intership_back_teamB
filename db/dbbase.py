...
#
#     group_student: Mapped[list["GroupStudent"]] = relationship(
...
#         "Group", back_populates="group_student")
...
#         "Group", back_populates="course", cascade="all, delete-orphan")
#
#
# class Subject(Base):
...
#         "User", back_populates="subjects", foreign_keys=[teacher_id])
...
#
#     lessons: Mapped[list["Lesson"]] = relationship(
#         "Lesson", back_populates="classroom", cascade="all, delete-orphan")
#
#
# class Schedule(Base):
...
#     group_id: Mapped[int] = mapped_column(
#         Integer, ForeignKey('groups.id'), nullable=False)
#     weekday: Mapped[int] = sa.Column(Integer, sa.CheckConstraint(
#         'weekday >= 0 AND weekday <= 6'), nullable=False)
#     created_at: Mapped[datetime] = mapped_column(
#         DateTime, default=get_current_time)
#
#     group: Mapped["Group"] = relationship("Group", back_populates="schedules")
#     lesson_schedule: Mapped[list["LessonSchedule"]] = relationship(
...
#         DateTime, default=get_current_time)
#
#     lessons: Mapped["Lesson"] = relationship(
#         "Lesson", back_populates="lesson_schedule")
#     schedule: Mapped["Schedule"] = relationship(
#         "Schedule", back_populates="lesson_schedule")
#
#
# class Lesson(Base):
...
#         "Subject", back_populates="lessons")
#     lesson_schedule: Mapped["LessonSchedule"] = relationship(
#         "LessonSchedule", back_populates="lessons")
#     classroom: Mapped["Classroom"] = relationship(
#         "Classroom", back_populates="lessons")
...
#         "Lesson", back_populates="homeworks")
